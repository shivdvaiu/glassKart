import 'package:eye_glass_store/ui/widgets/animated_gradient/animated_gradient.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: GestureDetector(
        ...
        child: AnimatedGradient(child: Container(
          decoration: BoxDecoration(
            // image: DecorationImage(
            //     // image: AssetImage(isLightMode
            //     //     ? AssetsPath.bgGradient
            //     //     : AssetsPath.drawerBgDark),
            //     fit: BoxFit.cover),
          ),
          child: Stack(
            children: <Widget>[
